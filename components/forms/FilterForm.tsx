...
export default function FilterForm({
            ...
            {showCompletedToggle ?
                <Field className="flex items-center relative text-white mx-4">
                    <Switch
                        ...
                        className="group relative inline-flex items-center h-8 w-16 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-gray-600 transition-colors duration-200 ease-in-out  data-[checked]:bg-lime-300"
                    >
                        <span
                            aria-hidden="true"
                            className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-gray-900 shadow ring-0 transition duration-200  ease-in-out ${values.showCompleted ? 'translate-x-9' : 'translate-x-1'}`} // Adjusted translate values
                        />
                    </Switch>
    ...
    return (
        ...
        <div className="relative">
            {filterMenu}
            <div className="w-[450px] bg-verto_bg mb-2 ring-1 ring-white rounded-xl px-3 py-4 absolute mt-2">
