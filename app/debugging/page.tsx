...
export default function Page() {
    ...
    const getOrderMethod = 'get_completed_orders'
    const showCompletedToggle = true;
    ...
    // Show only Orders that are complted and do not have a taker 
    // useEffect(() => {
    //     setFilteredOrders(orders.filter((order) => {
    //         return (order.status === 'Completed' && order.taker_id === null)
    //     }))
    // }, [filteredOrders])

    // Show orders that were taken by the account logged in
    // useEffect(() => {
    //     setFilteredOrders(orders.filter((order) => {
    //         return (order.status === 'Completed' && order.taker_id === accountId)
    //     }))
    // }, [filteredOrders])
